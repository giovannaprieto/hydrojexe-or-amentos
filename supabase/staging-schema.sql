-- ==========================================================================
-- MIGRAÇÕES COMPLETAS 0001..0031 — gerado por script.
-- Colar TUDO no SQL Editor de um projeto Supabase NOVO (staging), uma vez.
-- Ordem preservada. Cada bloco é idempotente (if not exists / on conflict).
-- ==========================================================================
